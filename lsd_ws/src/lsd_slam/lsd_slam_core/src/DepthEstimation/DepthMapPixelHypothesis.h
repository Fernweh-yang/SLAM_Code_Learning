...
public:
  ...
  inline DepthMapPixelHypothesis(const float& my_idepth, const float& my_idepth_smoothed, const float& my_idepth_var,
                                 const float& my_idepth_var_smoothed, const int& my_validity_counter)
    : isValid(true)
    , blacklisted(0)
  ...
  inline DepthMapPixelHypothesis(const float& my_idepth, const float& my_idepth_var, const int& my_validity_counter)
    : isValid(true)
    , blacklisted(0)
    , nextStereoFrameMinID(0)
    , validity_counter(my_validity_counter)
